...
cat ${SCRIPTS_ROOT}/templates/default | envsubst > $SCRIPTS_ROOT/swag/default

podman cp ${SCRIPTS_ROOT}/swag/default swag_cont:/config/nginx/site-confs/default
podman cp ${SCRIPTS_ROOT}/swag/nginx swag_cont:/config/nginx/nginx.conf
